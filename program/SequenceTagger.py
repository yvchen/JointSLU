...
if __name__ == "__main__":
    ...
    parser.add_argument('--train', dest='train_data_path', type=str, default='data/atis-2.train.lstm.iob', help='path to datasets')
    parser.add_argument('--dev', dest='dev_data_path', type=str, default=None, help='path to datasets')
    parser.add_argument('--test', dest='test_data_path', type=str, default='data/atis-2.test.lstm.iob', help='path to datasets')
    parser.add_argument('--out', dest='result_path', type=str, default='result', help='path to datasets')
    ...
    parser.add_argument('--embedding_file', dest='embedding_file', type = str, default='c:/Users/dilekha/Desktop/WORK/LSTM-experiments/LSTM-JFGAO/atis_data/atis.all.word2vec.emb', help='path to the embedding file')
    ...
    # regularization
    #parser.add_argument('-c', '--reg_cost', dest='reg_cost', type=float, default=1e-3, help='regularization')
    #parser.add_argument('--grad_clip', dest='grad_clip', type=float, default=-1e-4, help='clip gradients. if positive, at what threshold?')
    ...
    parser.add_argument('--mdl_path', dest='mdl_path', type = str, default='tmp_mdl/', help='the directory of storing tmp models')
